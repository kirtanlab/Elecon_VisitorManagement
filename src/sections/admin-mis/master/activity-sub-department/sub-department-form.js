...
export default function SubDepartmentForm({ currentUser }) {
                ...
                <Grid container xs={12} md={10} sx={{ marginTop: 5, }} justifyContent={'center'}>
                    <Card sx={{ p: 3, width: '80%', }}>
                        ...
                        >
                            ...
                            />
                            <RHFTextField name="subDepartment" label="Sub Department Name *" />
                        ...
                        </Box>
                        {
                                ...
                                <strong>Sub-Department name has been saved!</strong>
                            </Alert>
                        }

                        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
                            <LoadingButton type="submit" variant="contained" loading={isSubmitting}>
                                {!currentUser ? 'Add Sub Department' : 'Save Changes'}
                            </LoadingButton>
                        </Stack>
                    </Card>
                </Grid>
