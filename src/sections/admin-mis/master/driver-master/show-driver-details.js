...
export default function ShowDriverDetails() {
    ...
    const getVendor = async() => {
        try{
            ...
            for(const key in got){
                if(key === "_id" || key === "__v" || key === "visitors" || key === "created_date" || key === "created_by" || key === "updated_date" || key === "updated_by" || key === "deleted_date" || key === "deleted_by" || key === "employee_id"){
                    continue;
                }
                else if(key === "birth_date" || key === "join_date" || key === "license_exp_date" || key === "releave_date"){
                    tempVendor.push({key: key, value: formatDate(got[key])})
                }
                else{
                  if(got[key] === ""){
                    ...
                    if(key === "company")
                      tempVendor.push({key: key, value: got[key]["company_name"]});
                    // console.log(got[key]["company_name"])
                      ...
                      tempVendor.push({key: key, value: got[key]});
                  }
                }
            }
