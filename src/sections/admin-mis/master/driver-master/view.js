...
import DriverMasterRender from './driver-master-render';

// ----------------------------------------------------------------------

export default function DeriverMasterView() {
      ...
      currData ?
        <DriverMasterRender
          ...
          tableLabels={[
            ...
            { id: 'first_name', label: 'Driver Name' },
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Typography variant="h4"> Master - Driver Master </Typography>
