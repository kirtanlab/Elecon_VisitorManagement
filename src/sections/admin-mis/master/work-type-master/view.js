...
import WorkTypeMasterRender from './work-type-render';
// ----------------------------------------------------------------------

export default function WorkTypeMasterView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Typography variant="h4"> Master - Work Type Master </Typography>
