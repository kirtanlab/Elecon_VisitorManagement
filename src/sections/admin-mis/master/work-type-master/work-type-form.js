...
export default function WorkTypeMasterForm({ currentUser }) {
    ...
    const WorkTypeMasterSchema = Yup.object().shape({
    ...
    const methods = useForm({
        resolver: yupResolver(WorkTypeMasterSchema),
        defaultValues,
    });
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        try {
            const URL = `http://localhost:5000/api/v1/workType`
            ...
            <Grid container spacing={2}>
                ...
                <Grid container xs={12} md={10} sx={{ marginTop: 5, }} justifyContent={'center'}>
                    <Card sx={{ p: 3, width: '80%', }}>
                        {/* <Typography variant="h4">Work Master</Typography> */}
                        <Box
                            rowGap={3}
                            columnGap={2}
                            display="grid"
                        ...
                        </Box>
                        {
                                ...
                                <strong>Work Type has been added!</strong>
                            </Alert>
                        }

                        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
                            <LoadingButton type="submit" variant="contained" loading={isSubmitting}>
                                {!currentUser ? 'Add Work Type' : 'Save Changes'}
                            </LoadingButton>
                        </Stack>
                    </Card>
                </Grid>
