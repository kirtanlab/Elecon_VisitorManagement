...
export default function EditMakeModelForm({ currentUser }) {
  ...
  const getSpecificModel = async () => {
    try {
      ...
      setValue('modelName', res.data.data.make_and_model_name, { shouldValidate: true });
