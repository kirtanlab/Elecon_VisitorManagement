...
export default function LocationMasterForm({ currentUser }) {
    ...
    const LocationMasterSchema = Yup.object().shape({
    ...
    const methods = useForm({
        resolver: yupResolver(LocationMasterSchema),
        defaultValues,
    });
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        try {
            const URL = `http://localhost:5000/api/v1/location`
                ...
                <Grid container xs={12} md={10} sx={{ marginTop: 5, }} justifyContent={'center'}>
                    <Card sx={{ p: 3, width: '80%', }}>
                        ...
                        </Box>
                        {
                                ...
                                <strong>Location details has been saved!</strong>
                            </Alert>
                        }

                        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
                            <LoadingButton type="submit" variant="contained" loading={isSubmitting}>
                                {!currentUser ? 'Add Location' : 'Save Changes'}
                            </LoadingButton>
                        </Stack>
                    </Card>
                </Grid>
