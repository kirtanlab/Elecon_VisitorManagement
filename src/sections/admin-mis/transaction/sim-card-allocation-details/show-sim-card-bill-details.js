...
export default function ShowSimCardBillDetails() {
    ...
    try {
      ...
      for (const key in got) {
        if (
          ...
          else if(key === "requisition_date" || key === "issue_date_simcard" || key === "issue_date_datacard") {
...
ShowSimCardBillDetails.propTypes = {};
