...
export default function StaffVehicleDetailsView() {
  ...
  const getCurrData = async () => {
    try {
      const URL = `http://localhost:5000/api/v1/bill/makeAndModel/getAll`;
      console.log("get curr data for staff vehicle called")
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Typography variant="h4"> Transaction - Staff Vehicle Details </Typography>
