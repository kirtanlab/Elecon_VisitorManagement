...
import ShowStaffVehicleBillDetails from 'src/sections/mis-emp/staff-vehicle-details/show-staff-vehicle-details';
        ...
        <Container maxWidth={settings.themeStretch ? false : 'xl'}>
            <Card {...other}>
                ...
                <SearchBar
                    ...
                    placeholder='Employee, Vehicle, Company, Division, Department'
                />
          ...
          >
            <Box sx={{ p: 3, borderBottom: `solid 1px ${theme.palette.divider}` }}>
              <InputBase
                fullWidth
                autoFocus
                placeholder="Detail of Staff Vehicle Bills"
                value={''}
                onChange={() => {
                  '';
                }}
