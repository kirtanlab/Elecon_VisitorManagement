...
export default function ShowAssetBillDetails() {
    ...
    try {
      ...
      for (const key in got) {
        if (
          ...
          else if(key === "purchase_date" || key === "issue_date" || key === "cheque_date" || key === "transaction_date") {
...
ShowAssetBillDetails.propTypes = {};
