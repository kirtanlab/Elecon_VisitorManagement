...
export default function ShowManPowerBillDetails() {
  ...
  const getHotel = async () => {
    try {
      const URL = `http://localhost:5000/api/v1/bill/manPower/${itemMasterId}`;
      ...
      for (const key in got) {
        if (
          ...
          else if(key === "bill_date" || key === "month_year") {
...
ShowManPowerBillDetails.propTypes = {};
