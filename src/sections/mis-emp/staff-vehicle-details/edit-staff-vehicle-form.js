...
export default function EditStaffVehicleForm({ currentUser }) {
    ...
    const getSpecificStaffVehicle = async() => {
        try{
            ...
            console.log(err);
            alert("something went wrong in get specific staff vehicle");
        }
    }
...
EditStaffVehicleForm.propTypes = {
