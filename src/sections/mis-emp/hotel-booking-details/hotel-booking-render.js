...
import ShowHotelBillDetails from 'src/sections/admin-mis/transaction/hotel-booking-details/show-hotel-bill';
import EditHotelBookingForm from 'src/sections/admin-mis/transaction/hotel-booking-details/edit-hotel-bill';
            ...
            <Card {...other}>
                <CardHeader title={title} subheader={subheader} sx={{ mb: 0 }} />
                    <SearchBar
                        ...
                        placeholder='Hotel name or Guest name'
                    />
                    <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1} flexGrow={1} sx={{ width: 1, mb: 2, ml: 2  }}>
                    <Button
                        size="medium"
                        color="inherit"
          ...
          >
            <Box sx={{ p: 3, borderBottom: `solid 1px ${theme.palette.divider}` }}>
              <InputBase
                fullWidth
                autoFocus
                placeholder="Detail of Hotel booking"
                value={''}
                onChange={() => {
                  '';
                }}
