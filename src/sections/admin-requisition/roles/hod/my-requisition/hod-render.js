...
import ComplaintTableRowForEmp from "./complaint-table-row-emp";
import SearchBar from "src/components/search/Search-bar";
import AddRequisitionForm from "./add-requisition-form";
...
const TABLE_HEAD = [
  { id: 'title', label: 'Requisition Title', width: 100},
  { id: 'activity', label: 'Activity', width: 120},
//   { id: 'name', label: 'Employee', width: 100 },
  { id: 'requisition_date', label: 'Date' ,width: 170},
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <Card >
          ...
          <Dialog
              ...
              <Scrollbar sx={{ p: 3, pt: 2, height: 400 }}>{renderAddComplaint()}</Scrollbar>
          </Dialog>
