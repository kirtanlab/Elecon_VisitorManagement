...
export default function AdminRequisitionRow({ row, onViewRow }) {
  const { _id ,title, activity, emp_name, emp_email, requisition_date, status,} = row;
