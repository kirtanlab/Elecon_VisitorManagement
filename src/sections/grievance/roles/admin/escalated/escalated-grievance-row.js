...
export default function GrievanceTableRow({ row, onViewRow }) {
  const { _id ,title, message, grievance_type, emp_name, emp_email, grievance_date, status,} = row;
