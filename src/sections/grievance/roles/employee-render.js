...
import AddComplaintForm from "./employee/add-complaint-form";
...
const TABLE_HEAD = [
  { id: 'title', label: 'Complaint', width: 150},
  { id: 'grievance_type', label: 'Grievance Type', width: 150 },
  { id: 'grievance_date', label: 'Date' ,width: 170},
